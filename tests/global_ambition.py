...
def optimize_nsog():
    ...
    grid_data = pgim.file_io.read_grid(
        ...
        generators=TEST_DATA_ROOT_PATH / "generators_GA.csv",
        consumers=TEST_DATA_ROOT_PATH / "consumers_2050_GA.csv",
    )
    file_timeseries_sample = TEST_DATA_ROOT_PATH / "time_series_sample_2050_GA.csv"
    ...
    # Plot map
    plot_map2(grid_data, years=[2030, 2040], shapefile_path='/Users/tobiassjoli/PycharmProjects/tdg_powergim/tests'
