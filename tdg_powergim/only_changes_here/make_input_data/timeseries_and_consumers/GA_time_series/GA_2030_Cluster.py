...
def get_wind_values(wind_rows, country_code):
    ...
    df = pd.read_csv('/Users/tobiassjoli/Documents/GitHub/powergim/only_changes_here/make_input_data/timeseries_and_consumers/GA_time_series/wind_series_raw.csv')
...
def make_GA_demand_time_series():
    ...
    for sheet_name in sheet_names:
        file_path = os.path.join(folder_path, sheet_name + '_demand_data_2030_GA.csv')
    ...
    df.to_csv('time_series_sample_GA.csv', index=False)
    ...
    df_con.to_csv('consumers_GA_new.csv', index=False)

    return df


if __name__ == "__main__":
    make_GA_demand_time_series()
