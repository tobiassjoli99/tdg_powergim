...
class const:
    ...
    MAX_BRANCH_NEW_NUM = 10
    MAX_GEN_NEW_CAPACITY = 100000
    MAX_NODE_NEW_CAPACITY = 30000
...
class SipModel(pyo.ConcreteModel):
    ...
    def create_constraints(self):
        ...
        # TODO: add option to set minimum output = timeseries_and_consumers for renewable,
        ...
        # Power balance in nodes : gen+demand_functions+flow into node=0
        ...
        # Power into node vs node capacity : gen+demand_functions+flow into node=0
    ...
    def scenario_creator(self, scenario_name, probability):
        ...
        stage1 = self.investment_years[2]
